...
const FeedBackModal = (props) => {
  ...
  const intialData = useMemo(() => ({
    ...
    os_details: platform.os.family + platform.os.architecture + platform.os.version,
    from:
    ...
    if (openModal) {
      setTimeout(() => {
        ...
        html2canvas(body, {
          ...
          console.log('bodyCanvas', bodyCanvas);
        });
      }, 1000);
    }
    // } else {
    ...
    <div>
      ...
      >
        ...
        <DialogContent className={classes.content}>
          <DialogContentText>*Please click here for the existing feedback/defect</DialogContentText>
          <TextareaAutosize
        ...
        <DialogActions>
          ...
          <Button onClick={() => submitFeedback(formFields)} variant="contained" color="primary">
            Send
          </Button>
        </DialogActions>
      </Dialog>
